---
title: using an iphone after four years of android
tagline: some key differences i've noticed using an iphone for a week after using android for four years
date: 2026-02-20
post_tags:
  - phones
  - android
...
- **app sideloading:** you’re *technically* allowed to sideload apps on ios now (after years of resisting, the EU made them do it lol), but the process seems to be a massive pain. it’s nowhere near as simple as downloading an apk file, allowing installing apps from unknown sources, and installing it, like you do on android. i’m not even going to attempt to explain the installation process for ios, just read [this guide on installing the altstore](https://faq.altstore.io/altstore-classic/how-to-install-altstore-windows). to make matters worse, apparently it’s easier to install apps from external sources in the EU than it is anywhere else, and there’s also a lot more stipulations
