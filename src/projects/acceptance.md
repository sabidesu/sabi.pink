...
name: acceptance
description: >-
  this was my final project for cs1110, introduction to programming. it's a
  basic side-scroller with completely original assets, text-based level
  generation, 2-player support on one keyboard, and more
view_link:
